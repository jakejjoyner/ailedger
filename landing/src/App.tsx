  ...
  return (
    <section className="hero-section" style={{
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        <p className="hero-subtitle fade-in fade-3" style={{ fontSize: 20, color: '#94a3b8', lineHeight: 1.7, marginBottom: 44, maxWidth: 620, margin: '0 auto 44px' }}>
          A drop-in proxy for OpenAI, Anthropic, and Gemini that turns every AI call into a tamper-evident audit record — and exports the PDF report regulators ask for under EU AI Act Article 12.
        </p>
    ...
    <section className="section-pad" style={{
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          ...
          <p style={{ fontSize: 17, color: '#64748b', maxWidth: 480, margin: '0 auto' }}>
            Not just a dashboard - infrastructure built for the audit trail regulators require.
          </p>
        </div>
