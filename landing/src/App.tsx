    ...
    <section className="hero-section" style={{
      ...
      <div style={{ maxWidth: 'min(92vw, 1280px)', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        <h1 className="hero-title" style={{
          ...
          <span className={`hero-title-accent fade-in fade-2b ${anim}`} style={{ display: 'block', fontSize: 'clamp(30px, 5vw, 68px)', letterSpacing: '-0.025em' }}><span style={{ color: '#818cf8' }}>every</span> AI decision.</span>
        </h1>
      ...
      <section className="section-pad" style={{ padding: '120px 32px 72px', textAlign: 'center' }}>
        <div style={{ maxWidth: 820, margin: '0 auto' }}>
          <h1 style={{ fontSize: 56, fontWeight: 700, color: '#fff', letterSpacing: '-1.5px', lineHeight: 1.1, marginBottom: 24 }}>
            Audit-grade evidence for <span style={{ color: '#818cf8' }}>every</span> AI call your product makes.
          </h1>
